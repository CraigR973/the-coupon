...
# source-command-ship-prod

Use this skill when the user asks to run the migrated source command `ship-prod`.
...
- For long polls, use Bash `run_in_background: true` with an `until` loop.
